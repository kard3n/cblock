...
def stem_tokenize_string(string: str) -> str:
    result: [str] = []
...
def create_classifier(
    language: str, param_grid: dict, select_k_features: int
) -> None:
    """
    ...
    cloudpickle.dump(pipeline, open(os.path.dirname(os.path.realpath(__file__)) + "/classifier_" + language + ".pickle", "wb"))
